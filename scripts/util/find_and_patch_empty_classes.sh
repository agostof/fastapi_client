...
patch_empty_class() {
  ...
  CLASS_FILE=$3
  CLASS_NAME=$4
  BASE_CLASS=$(echo $CLASS_NAME |sed 's/NewRequest(BaseModel):/BaseClass/g')
  ...
  echo "     __root__:${BASE_CLASS}" >> ${WORK_DIR}/${PACKAGE_NAME}/models/${CLASS_FILE}
...
do
    ...
    patch_empty_class ${PACKAGE_NAME} ${WORK_DIR} ${CLASS_FILE} ${CLASS_NAME}
